...
import olog.dev.leeto.fragment_no_journey.NoJourneyFragment;
...
public class MainActivity extends BaseActivity implements MainContract.View {
    ...
    public void showJourneysList(@NonNull List<Journey> data) {
        ...
        Timber.d("showJourneysList, noJourneyFragment is null?=" + (fragment == null));
        if(fragment != null){
    ...
    public void showNoJourneysFragment() {
        ...
        if(findFragmentByTag(NoJourneyFragment.TAG) == null){
            getSupportFragmentManager().beginTransaction()
                    .setReorderingAllowed(true)
                    .add(R.id.root, NoJourneyFragment.newInstance(), NoJourneyFragment.TAG)
                ...
                .addCallback(new Snackbar.Callback(){
                    ...
                    public void onDismissed(Snackbar transientBottomBar, int event) {
                        ...
                        if(event != DISMISS_EVENT_ACTION){
                            ...
                            // TODO bug, non si aggiorna il layout dopo l'eliminazione
                        }
                    }
                })
                .show();
