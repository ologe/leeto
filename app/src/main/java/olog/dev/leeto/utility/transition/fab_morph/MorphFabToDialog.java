package olog.dev.leeto.utility.transition.fab_morph;
...
public class MorphFabToDialog extends ChangeBounds {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR,  ContextCompat.getColor(view.getContext(), R.color.dark_grey));
